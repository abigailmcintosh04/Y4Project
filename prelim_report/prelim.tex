...
Phenomenological models like fragmentation require tuning of parameters matching experimental data. By improving the efficiency of identifying charm hadrons, the accuracy of Monte Carlo generators such as PYTHIA can be improved.
