...
\begin{figure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \label{fig:d0}
    \end{subfigure}
    \caption{Distributions of distinguishing variables for charmed hadrons. A sample of 1 million charm hadron events was generated}
